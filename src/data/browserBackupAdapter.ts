...
export const browserBackupAdapter: BackupStateAdapter = {
  read: () => {
    ...
    return cloneData({
      ...
      settings: {
        ...
        showWordsDailySummary: settings.showWordsDailySummary,
        dashboardCardOrder: settings.dashboardCardOrder,
        dashboardCardVisibility: settings.dashboardCardVisibility,
  ...
  write: (data) => {
    ...
    useSettingsStore.setState({
      ...
      showWordsDailySummary: snapshot.settings.showWordsDailySummary,
      dashboardCardOrder: snapshot.settings.dashboardCardOrder,
      dashboardCardVisibility: snapshot.settings.dashboardCardVisibility,
